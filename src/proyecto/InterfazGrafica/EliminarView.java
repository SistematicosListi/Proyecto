...
public class EliminarView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btn_salir.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 80, 54, 30));
        ...
        btn_salir.add(txt_clave, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 80, 290, 30));

        jButton1.setBackground(new java.awt.Color(0, 129, 255));
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/proyecto/resources/img_iconos/cerrar-sesion (1).png"))); // NOI18N
        jButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton1ActionPerformed(evt);
            }
        });
        btn_salir.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 6, 57, -1));

        getContentPane().add(btn_salir, java.awt.BorderLayout.CENTER);
    ...
    private void btn_eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_eliminarActionPerformed
        ...
        Producto p = inventario.buscarProducto(clave);
        
        if(p != null){
            new EliminarDialog(this, true, p).setVisible(true);
        } else{
            return;
        }
